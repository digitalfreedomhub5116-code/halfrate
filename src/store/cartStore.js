...
const loadInitialProducts = () => {
  try {
    ...
    try {
      localStorage.removeItem('halfrate_catalog_v14')
      localStorage.removeItem('halfrate_catalog_v13')
      localStorage.removeItem('halfrate_catalog_v12')
      localStorage.removeItem('halfrate_catalog_v11')
      ...
      localStorage.removeItem('halfrate_catalog_v6')
      localStorage.removeItem('halfrate_catalog_v5')
      localStorage.removeItem('halfrate_catalog_v4')
