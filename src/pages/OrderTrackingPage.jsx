...
export default function OrderTrackingPage() {
  ...
  // 6 Checkpoints matching halfrate.co fulfillment pipeline
  const STAGES = [
    {
      key: 'PLACED',
      step: '01',
          ...
          {ordersLoading ? (
            ...
            <div className="rounded-2xl border border-[#E7E2D9] bg-white p-10 text-center space-y-3 shadow-xs">
              ...
              <p className="text-xs text-[#78716C] max-w-sm mx-auto">
                Once you place an order on halfrate.co, you can track testing, packaging, and delivery progress here.
              </p>
              <Link
                to="/"
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-3 pt-3 border-t border-[#E7E2D9] flex flex-wrap items-center justify-between gap-2">
                    ...
                    <span className="text-[11px] text-[#78716C] font-mono">
                      Carrier: {order.shipment?.courier_partner || 'HalfRate Express Logistics'}
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className="pt-4 border-t border-red-200 space-y-6">
            ...
            <div className="rounded-2xl border border-rose-200 bg-rose-50/50 p-5 sm:p-6">
              ...
              <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                <div className="space-y-1">
                  ...
                  <p className="text-[#1C1917] font-medium">
                    {cancelDetails?.cancellation_reason || 'Cancelled by seller in halfrate.co portal'}
                  </p>
                </div>
              ...
              <div className="mt-4 pt-3 border-t border-rose-200 flex flex-wrap items-center justify-between gap-3 text-xs">
                ...
                <div className="flex items-center gap-3">
                  <a
                    href={`mailto:support@halfrate.co?subject=Help with Order ${order.order_number}`}
            ...
            <div className="relative pl-3 sm:pl-4 space-y-6 pt-2">
              <div className="relative flex items-start gap-4 sm:gap-5">
                ...
                <div className="pt-1">
                  ...
                  <p className="text-xs text-[#78716C]">Order confirmed on halfrate.co</p>
                </div>
              </div>
